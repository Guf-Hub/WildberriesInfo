...
Не лазийте в скрипт и не меняйте его версию, изменения между версиями могут быть значительными и ваша выгрузка перестанет работать. Обратитесь в [Поддержку](https://t.me/nosaev_m), если необходимы обновления их сделают.
